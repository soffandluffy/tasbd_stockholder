...
<body id="kt_body"
                ...
                <div class="aside-menu flex-column-fluid">
                    ...
                    <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                            ...
                            <div class="menu-item">
                                <a class="menu-link active" href="stock.php">
                                    <span class="menu-icon">
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                                ...
                                <!--begin::Title-->
                                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Stock List</h1>
                                <!--end::Title-->
                                <!--begin::Separator-->
                                ...
                                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                                    ...
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <li class="breadcrumb-item text-muted">Stock</li>
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <li class="breadcrumb-item">
                                        <span class="bullet bg-gray-200 w-5px h-2px"></span>
                                    ...
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <li class="breadcrumb-item text-dark">Stock List</li>
                                    <!--end::Item-->
                                </ul>
                                <!--end::Breadcrumb-->
                            </div>
                        ...
                        <div id="kt_content_container" class="container">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header border-0 pt-6">
                                    ...
                                    <div class="card-title">
                                        ...
                                        <div class="d-flex align-items-center position-relative my-1">
                                            ...
                                            <!--end::Svg Icon-->
                                            <input type="text" data-kt-stock-table-filter="search"
                                    ...
                                    <div class="card-toolbar">
                                        <!--begin::Toolbar-->
                                        <div class="d-flex justify-content-end" data-kt-stock-table-toolbar="base">
                                            <!--begin::Add stock-->
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#kt_modal_add_stock">
                                ...
                                <div class="card-body pt-0">
                                    <!--begin::Table-->
                                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_stock_table">
                                        <!--begin::Table head-->
                                        <thead>
                                            <!--begin::Table row-->
                                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                                <th class="min-w-125px text-center">Stock ID</th>
                                                <th class="min-w-125px text-center">Company</th>
                                                <th class="min-w-125px text-center">Employee</th>
                                        ...
                                        <tbody class="fw-bold text-gray-600">
                                            <?php
                                                $query = "SELECT s.id_stock, s.id_company, s.id_employee, s.qty, c.name as companyname, e.name as empname FROM stock s INNER JOIN company c ON c.id_company = s.id_company INNER JOIN employee e ON e.id_employee = s.id_employee";
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><?php echo $data["empname"]; ?></td>
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <a href="#" class="menu-link px-3" data-bs-toggle="modal"
                                                                data-bs-target="#kt_modal_edit_stock<?php echo $data["id_stock"]; ?>">Edit</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="#" class="menu-link px-3" data-bs-toggle="modal"
                                                                data-bs-target="#kt_modal_delete_stock<?php echo $data["id_stock"]; ?>">Delete</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                    </div>
                                                    <!--end::Menu-->
                                                ...
                                                <!--end::Action=-->
                                                <!--begin::Modal - Stock - Delete-->
                                                <div class="modal fade" tabindex="-1" aria-hidden="true"
                                                    id="kt_modal_delete_stock<?php echo $data["id_stock"]; ?>">
                                                    <!--begin::Modal dialog-->
                                                    <div class="modal-dialog modal-dialog-centered mw-650px">
                                                        <!--begin::Modal content-->
                                                        <div class="modal-content">
                                                            <!--begin::Form-->
                                                            <form class="form" action="stock.php" method="POST">
                                                                <!--begin::Modal header-->
                                                                <div class="modal-header">
                                                                    <!--begin::Modal title-->
                                                                    <h2 class="fw-bolder">Delete Stock</h2>
                                                                    <!--end::Modal title-->
                                                                    <!--begin::Close-->
                                                ...
                                                <!--end::Modal - Stock - Delete-->
                                                <!--begin::Modal - Stock - Edit-->
                                                <div class="modal fade" tabindex="-1" aria-hidden="true"
                                                    id="kt_modal_edit_stock<?php echo $data["id_stock"]; ?>">
                                                    <!--begin::Modal dialog-->
                                                    <div class="modal-dialog modal-dialog-centered mw-650px">
                                                        <!--begin::Modal content-->
                                                        <div class="modal-content">
                                                            ...
                                                            <form class="form" action="stock.php" method="POST">
                                                                ...
                                                                <div class="modal-header">
                                                                    <!--begin::Modal title-->
                                                                    <h2 class="fw-bolder">Edit Stock</h2>
                                                                    <!--end::Modal title-->
                                                                    <!--begin::Close-->
                                                                    <div class="btn btn-icon btn-sm btn-active-icon-primary"
                                                                        data-bs-dismiss="modal">
                                                                ...
                                                                <div class="modal-body py-10 px-lg-17">
                                                                    ...
                                                                    <div class="scroll-y me-n7 pe-7"
                                                                        ...
                                                                        data-kt-scroll-dependencies="#kt_modal_edit_stock_header"
                                                                        data-kt-scroll-wrappers="#kt_modal_edit_stock_scroll"
                                                                        ...
                                                                        <div class="mb-10">
                                                                            ...
                                                                            <div>
                                                                                <select name="id_company"
                                                                                    ...
                                                                                    data-dropdown-parent="#kt_modal_edit_stock<?php echo $data["id_stock"]; ?>">
                                                                                    <option></option>
                                                                                    <?php
                                                                                        $query2 = "SELECT id_company,name FROM company";
                                                                                        $result2 = mysqli_query($con, $query2);
                                                                                        while($cmp = mysqli_fetch_array($result2)) {
                                                                                            if($cmp["id_company"] == $data["id_company"]) {
                                                                                    ?>
                                                                                    <option
                                                                                        value="<?php echo $cmp['id_company']; ?>"
                                                                                        selected>
                                                                                        <?php echo $cmp['name']; ?>
                                                                                    </option>
                                                                                    <?php
                                                                        ...
                                                                        <div class="mb-10">
                                                                            ...
                                                                            <div>
                                                                                <select name="id_employee"
                                                                                    ...
                                                                                    <option></option>
                                                                                    <?php
                                                                                        $query3 = "SELECT id_employee,name FROM employee";
                                                                                        $result3 = mysqli_query($con, $query3);
                                                                                        while($emp = mysqli_fetch_array($result3)) {
                                                                                            if($emp["id_employee"] == $data["id_employee"]) {
                                                                                    ?>
                                                                                    <option
                                                                                        value="<?php echo $emp['id_employee']; ?>"
                                                                                        selected>
                                                                                        <?php echo $emp['name']; ?>
                                                                                    </option>
                                                                                    <?php
                                                                        ...
                                                                        <div class="fv-row mb-7">
                                                                            <!--begin::Label-->
                                                                            <label
                                                                                class="required fs-6 fw-bold mb-2">Quantity</label>
                                                                            <!--end::Label-->
                                                                            <!--begin::Input-->
                                                                            <input type="text"
                            ...
                            <!--begin::Modal - Stock - Add-->
                            <div class="modal fade" id="kt_modal_add_stock" tabindex="-1" aria-hidden="true">
                                <!--begin::Modal dialog-->
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                    <!--begin::Modal content-->
                                    <div class="modal-content">
                                        <!--begin::Form-->
                                        <form class="form" action="stock.php" id="kt_modal_add_stock_form"
                                            method="POST">
                                            <!--begin::Modal header-->
                                            <div class="modal-header" id="kt_modal_add_stock_header">
                                                <!--begin::Modal title-->
                                                <h2 class="fw-bolder">Add a Stock</h2>
                                                <!--end::Modal title-->
                                                <!--begin::Close-->
                                                <div id="kt_modal_add_stock_close"
                                            ...
                                            <div class="modal-body py-10 px-lg-17">
                                                <!--begin::Scroll-->
                                                <div class="scroll-y me-n7 pe-7" id="kt_modal_add_stock_scroll"
                                                    data-kt-scroll="true"
                                                    data-kt-scroll-activate="{default: false, lg: true}"
                                                    data-kt-scroll-max-height="auto"
                                                    data-kt-scroll-dependencies="#kt_modal_add_stock_header"
                                                    data-kt-scroll-wrappers="#kt_modal_add_stock_scroll"
                                                    data-kt-scroll-offset="300px">
                                                    <!--begin::Input group-->
                                                    <div class="mb-10">
                                                        <!--begin::Label-->
                                                        ...
                                                        <div>
                                                            <select name="id_company"
                                                                ...
                                                                data-dropdown-parent="#kt_modal_add_stock" required>
                                                                <option></option>
                                                                <?php
                                                    ...
                                                    <div class="mb-10">
                                                        <!--begin::Label-->
                                                        <label class="required form-label fw-bold">Employee
                                                            :</label>
                                                        <!--end::Label-->
                                                        <!--begin::Input-->
                                                        <div>
                                            ...
                                            <div class="modal-footer flex-center">
                                                <!--begin::Button-->
                                                <button type="reset" id="kt_modal_add_stock_cancel"
                                                    class="btn btn-light me-3" data-bs-dismiss="modal">Cancel</button>
                                                <!--end::Button-->
                                                <!--begin::Button-->
                                                <button type="submit" id="kt_modal_add_stock_submit"
    ...
    <?php
        ...
        if(isset($_SESSION["addsuccess"])) {
            callSwal("Stock added", 'success', true);
            unset($_SESSION["addsuccess"]);
        } else if(isset($_SESSION["updatesuccess"])) {
            callSwal("Stock updated", 'success', true);
            unset($_SESSION["updatesuccess"]);
        } else if(isset($_SESSION["deletesuccess"])) {
            callSwal("Stock deleted", 'success', true);
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            if($_POST["method"] == "INSERT") {
                try {
                    $qty = $_POST["qty"];
                    $stmt = mysqli_prepare($con, "INSERT INTO stock VALUES('', ? , ?, ?)");
                    // Bind variables to the prepared statement as parameters
                    mysqli_stmt_bind_param($stmt, "iii", $param_idcompany, $param_idemployee, $param_qty);
                    $param_idcompany = trim($_POST["id_company"]);
                    $param_idemployee = trim($_POST["id_employee"]);
                    $param_qty = $qty;
                ...
                try {
                    $qty = $_POST["qty"];
                    $stmt = mysqli_prepare($con, "UPDATE stock SET id_company = ?,id_employee = ?,qty = ? WHERE id_stock = ?");
                    // Bind variables to the prepared statement as parameters
                    mysqli_stmt_bind_param($stmt, "iiii", $param_idcompany, $param_idemployee, $param_qty, $param_id);
                    $param_idcompany = trim($_POST["id_company"]);
                    $param_idemployee = trim($_POST["id_employee"]);
                    $param_qty = $qty;
                    $param_id = trim($_POST["id_stock"]);
                    // Attempt to execute the prepared statement
                    if(mysqli_stmt_execute($stmt)){
                        // Records deleted successfully. Redirect to landing page
                ...
                try {
                    $stmt = mysqli_prepare($con, "DELETE FROM stock WHERE id_stock = ?");
                    // Bind variables to the prepared statement as parameters
