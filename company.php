...
<body id="kt_body"
                ...
                <div class="aside-menu flex-column-fluid">
                    ...
                    <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                            ...
                            <div class="menu-item">
                                <a class="menu-link active" href="company.php">
                                    <span class="menu-icon">
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                                ...
                                <!--begin::Title-->
                                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Company List</h1>
                                <!--end::Title-->
                                <!--begin::Separator-->
                                ...
                                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                                    ...
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <li class="breadcrumb-item text-dark">Companies List</li>
                                    <!--end::Item-->
                                </ul>
                                <!--end::Breadcrumb-->
                            </div>
                        ...
                        <div id="kt_content_container" class="container">
                                ...
                                <div class="card-header border-0 pt-6">
                                    ...
                                    <div class="card-title">
                                        ...
                                        <div class="d-flex align-items-center position-relative my-1">
                                            ...
                                            <!--end::Svg Icon-->
                                            <input type="text" data-kt-company-table-filter="search"
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <div class="d-flex justify-content-end align-items-center d-none"
                                            ...
                                            <div class="fw-bolder me-5">
                                                <span class="me-2"
                                                    data-kt-company-table-select="selected_count"></span>Selected
                                            </div>
                                            <button type="button" class="btn btn-danger"
                                                data-kt-company-table-select="delete_selected">Delete Selected</button>
                                        </div>
                                        <!--end::Group actions-->
                                    </div>
                                    <!--end::Card toolbar-->
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_company_table">
                                        ...
                                        <thead>
                                            ...
                                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                                ...
                                                <th class="min-w-125px text-center">Company Name</th>
                                        ...
                                        <tbody class="fw-bold text-gray-600">
                                            ...
                                            ?>
                                            <tr>
                                                <td class="text-center"><?php echo $data["id_company"]; ?></td>
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <a href="#" class="menu-link px-3" data-bs-toggle="modal"
                                                                data-bs-target="#kt_modal_edit_company<?php echo $data["id_company"]; ?>">Edit</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="#" class="menu-link px-3" data-bs-toggle="modal"
                                                                data-bs-target="#kt_modal_delete_company<?php echo $data["id_company"]; ?>">Delete</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                    </div>
                                                    <!--end::Menu-->
                                                ...
                                                <!--end::Action=-->
                                                <!--begin::Modal - Company - Delete-->
                                                <div class="modal fade" tabindex="-1" aria-hidden="true"
                                                    id="kt_modal_delete_company<?php echo $data["id_company"]; ?>">
                                                    <!--begin::Modal dialog-->
                                                    <div class="modal-dialog modal-dialog-centered mw-650px">
                                                        <!--begin::Modal content-->
                                                        <div class="modal-content">
                                                            <!--begin::Form-->
                                                            <form class="form" action="company.php" method="POST">
                                                                <!--begin::Modal header-->
                                                                <div class="modal-header">
                                                                    <!--begin::Modal title-->
                                                                    <h2 class="fw-bolder">Delete Company</h2>
                                                                    <!--end::Modal title-->
                                                                    <!--begin::Close-->
                                                                ...
                                                                <div class="modal-body py-10 px-lg-17">
                                                                    ...
                                                                    <input type="hidden" name="id_company"
                                                                        value="<?php echo $data["id_company"]; ?>">
                                                ...
                                                <!--end::Modal - Company - Delete-->
                                                <!--begin::Modal - Company - Edit-->
                                                <div class="modal fade" tabindex="-1" aria-hidden="true"
                                                    id="kt_modal_edit_company<?php echo $data["id_company"]; ?>">
                                                    <!--begin::Modal dialog-->
                                                    <div class="modal-dialog modal-dialog-centered mw-650px">
                                                        <!--begin::Modal content-->
                                                        <div class="modal-content">
                                                            ...
                                                            <form class="form" action="company.php" method="POST">
                                                                ...
                                                                <div class="modal-header">
                                                                    <!--begin::Modal title-->
                                                                    <h2 class="fw-bolder">Edit Company</h2>
                                                                    <!--end::Modal title-->
                                                                    <!--begin::Close-->
                                                                    <div class="btn btn-icon btn-sm btn-active-icon-primary"
                                                                        data-bs-dismiss="modal">
                                                                ...
                                                                <div class="modal-body py-10 px-lg-17">
                                                                    ...
                                                                    <div class="scroll-y me-n7 pe-7"
                                                                        ...
                                                                        data-kt-scroll-dependencies="#kt_modal_edit_company_header"
                                                                        data-kt-scroll-wrappers="#kt_modal_edit_company_scroll"
                            ...
                            <div class="modal fade" id="kt_modal_add_company" tabindex="-1" aria-hidden="true">
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                    ...
                                    <div class="modal-content">
                                        <!--begin::Form-->
                                        <form class="form" action="company.php" id="kt_modal_add_company_form"
                                            method="POST">
                                            <!--begin::Modal header-->
                                            <div class="modal-header" id="kt_modal_add_company_header">
                                                <!--begin::Modal title-->
                                                <h2 class="fw-bolder">Add a Company</h2>
                                                <!--end::Modal title-->
                                                <!--begin::Close-->
                                                <div id="kt_modal_add_company_close"
                                            ...
                                            <div class="modal-body py-10 px-lg-17">
                                                <!--begin::Scroll-->
                                                <div class="scroll-y me-n7 pe-7" id="kt_modal_add_company_scroll"
                                                    data-kt-scroll="true"
                                                    data-kt-scroll-activate="{default: false, lg: true}"
                                                    data-kt-scroll-max-height="auto"
                                            ...
                                            <div class="modal-footer flex-center">
                                                <!--begin::Button-->
                                                <button type="reset" id="kt_modal_add_company_cancel"
                                                    class="btn btn-light me-3" data-bs-dismiss="modal">Cancel</button>
                                                <!--end::Button-->
                                                <!--begin::Button-->
                                                <button type="submit" id="kt_modal_add_company_submit"
    ...
    <?php
        ...
        if(isset($_SESSION["addsuccess"])) {
            callSwal("Company added", 'success', true);
            unset($_SESSION["addsuccess"]);
        } else if(isset($_SESSION["updatesuccess"])) {
            callSwal("Company updated", 'success', true);
            unset($_SESSION["updatesuccess"]);
        } else if(isset($_SESSION["deletesuccess"])) {
            callSwal("Company deleted", 'success', true);
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            if($_POST["method"] == "INSERT") {
                try {
                    $name = $_POST["name"];
                    $sql = $con->prepare("INSERT INTO company VALUES('', ?)");
                ...
                try {
                    $name = $_POST["name"];
                    $stmt = mysqli_prepare($con, "UPDATE company SET name = ? WHERE id_company = ?");
                    // Bind variables to the prepared statement as parameters
                    mysqli_stmt_bind_param($stmt, "si", $param_name, $param_id);
                    $param_name = $name;
                    $param_id = trim($_POST["id_company"]);
                ...
                try {
                    $stmt = mysqli_prepare($con, "DELETE FROM company WHERE id_company = ?");
                    // Bind variables to the prepared statement as parameters
